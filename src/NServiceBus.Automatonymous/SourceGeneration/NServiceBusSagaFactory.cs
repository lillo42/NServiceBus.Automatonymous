...
internal class NServiceBusSagaFactory
{
    public static ClassBuilder Create(SagaInformation saga)
    {
        ...
        return new ClassBuilder(new StringBuilder())
                .SetClassName(className)
                .SetBaseType($"NServiceBusSaga<{saga.Class.Identifier.Text}, {saga.StateSymbol.Name}>")
                ...
                .AddUsing(saga.StateSymbol.ContainingNamespace.ToDisplayString())
